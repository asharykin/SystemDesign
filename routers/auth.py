...
def login_for_access_token(form_data: OAuth2PasswordRequestForm = Depends(), expiration_min: int = Form(DEFAULT_EXPIRATION_TIME)):
...
def create_access_token(username, expiration_min):
    ...
    expiration = expiration + timedelta(hours=3)
